...
+ LOTTE_KIND: p4a
+ FIRST_BUY_DATE: 2025.05.11
+ TCK_KIND: All 4 exact order
+ BROKER_COST: $0.3 / ticket

==> [GOAL] Simulate buying tickets, track results and calculate ROI. By the way, real buying based on "Research project B - Plan A" with 5 times tickets.
```
...
![](https://github.com/dinhtt-randrise/orottick4/blob/a8fb0d8c40fe3183a3771530b48c83d76f4bf316/research/rsp-b/p4a-rsp-b-plan-a-analyze.png)
